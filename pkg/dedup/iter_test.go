...
func (s series) Labels() labelpb.Labels { return s.lset }
...
func (s *mockedSeriesSet) At() Series {
...
func (s *chunkedSeriesSet) At() (labelpb.Labels, []*storepb.AggrChunk) {
...
func TestOverlapSplitSet(t *testing.T) {
	input := []chunkedSeries{
		{
			lset: labelpb.FromStrings("a", "1_empty"),
		},
		{
			lset:   labelpb.FromStrings("a", "2_nonoverlap"),
			chunks: []*storepb.AggrChunk{{MinTime: 0, MaxTime: 20}, {MinTime: 21, MaxTime: 100}, {MinTime: 110, MaxTime: 300}},
		},
		{
			lset:   labelpb.FromStrings("a", "3_tworeplicas"),
