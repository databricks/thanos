...
func (m *TargetsRequest) CloneVT() *TargetsRequest {
	if m == nil {
		return (*TargetsRequest)(nil)
	}
	r := new(TargetsRequest)
	r.State = m.State
	r.PartialResponseStrategy = m.PartialResponseStrategy
	return r
}

func (m *TargetsRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TargetsResponse) CloneVT() *TargetsResponse {
	if m == nil {
		return (*TargetsResponse)(nil)
	}
	r := new(TargetsResponse)
	if m.Result != nil {
		r.Result = m.Result.(interface {
			CloneVT() isTargetsResponse_Result
		}).CloneVT()
	}
	return r
}

func (m *TargetsResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TargetsResponse_Targets) CloneVT() isTargetsResponse_Result {
	if m == nil {
		return (*TargetsResponse_Targets)(nil)
	}
	r := new(TargetsResponse_Targets)
	r.Targets = m.Targets.CloneVT()
	return r
}

func (m *TargetsResponse_Warning) CloneVT() isTargetsResponse_Result {
	if m == nil {
		return (*TargetsResponse_Warning)(nil)
	}
	r := new(TargetsResponse_Warning)
	r.Warning = m.Warning
	return r
}

func (m *TargetDiscovery) CloneVT() *TargetDiscovery {
	if m == nil {
		return (*TargetDiscovery)(nil)
	}
	r := new(TargetDiscovery)
	if rhs := m.ActiveTargets; rhs != nil {
		tmpContainer := make([]*ActiveTarget, len(rhs))
		for k, v := range rhs {
	...
	if rhs := m.DroppedTargets; rhs != nil {
		tmpContainer := make([]*DroppedTarget, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *TargetDiscovery) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *ActiveTarget) CloneVT() *ActiveTarget {
	if m == nil {
		return (*ActiveTarget)(nil)
	}
	r := new(ActiveTarget)
	r.DiscoveredLabels = m.DiscoveredLabels.CloneVT()
	r.Labels = m.Labels.CloneVT()
	r.ScrapePool = m.ScrapePool
	r.ScrapeUrl = m.ScrapeUrl
	r.GlobalUrl = m.GlobalUrl
	r.LastError = m.LastError
	r.LastScrape = (*timestamppb.Timestamp)((*timestamppb1.Timestamp)(m.LastScrape).CloneVT())
	r.LastScrapeDuration = m.LastScrapeDuration
	r.Health = m.Health
	return r
}

func (m *ActiveTarget) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *DroppedTarget) CloneVT() *DroppedTarget {
	if m == nil {
		return (*DroppedTarget)(nil)
	}
	r := new(DroppedTarget)
	r.DiscoveredLabels = m.DiscoveredLabels.CloneVT()
	return r
...
func (m *DroppedTarget) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *ActiveTarget) EqualVT(that *ActiveTarget) bool {
	...
	if !(*timestamppb1.Timestamp)(this.LastScrape).EqualVT((*timestamppb1.Timestamp)(that.LastScrape)) {
		return false
	}
...
func (m *ActiveTarget) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LastScrape != nil {
		size, err := (*timestamppb1.Timestamp)(m.LastScrape).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ActiveTarget) SizeVT() (n int) {
	...
	if m.LastScrape != nil {
		l = (*timestamppb1.Timestamp)(m.LastScrape).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.LastScrapeDuration != 0 {
		n += 9
...
func (m *ActiveTarget) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if err := (*timestamppb1.Timestamp)(m.LastScrape).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
