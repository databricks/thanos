...
func TestProxyResponseTreeSortWithBatchResponses(t *testing.T) {
	...
	respSet1 := newEagerRespSet(
		...
		false,
		factory.NewCounter(prometheus.CounterOpts{Name: "test_eager_1"}),
		nil,
	)
	respSet2 := newEagerRespSet(
		...
		shardInfo.Matcher(nil),
		false,
		factory.NewCounter(prometheus.CounterOpts{Name: "test_eager_2"}),
		nil,
	)
...
func TestLazyRespSetUnpacksBatchResponses(t *testing.T) {
	...
	respSet1 := newLazyRespSet(
		...
		shardInfo.Matcher(nil),
		false,
		factory.NewCounter(prometheus.CounterOpts{Name: "test_lazy_1"}),
		10,
	)
	respSet2 := newLazyRespSet(
		...
		shardInfo.Matcher(nil),
		false,
		factory.NewCounter(prometheus.CounterOpts{Name: "test_lazy_2"}),
		10,
	)
