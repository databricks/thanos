...
func (m *QueryResponse_Stats) CloneVT() isQueryResponse_Result {
	if m == nil {
		return (*QueryResponse_Stats)(nil)
	}
	r := new(QueryResponse_Stats)
...
func (m *QueryPlan) CloneVT() *QueryPlan {
	...
	r := new(QueryPlan)
	if m.Encoding != nil {
		r.Encoding = m.Encoding.(interface{ CloneVT() isQueryPlan_Encoding }).CloneVT()
	}
	return r
}
...
func (m *QueryPlan_Json) CloneVT() isQueryPlan_Encoding {
	if m == nil {
		return (*QueryPlan_Json)(nil)
	}
	r := new(QueryPlan_Json)
...
func (m *QueryRangeResponse_Stats) CloneVT() isQueryRangeResponse_Result {
	if m == nil {
		return (*QueryRangeResponse_Stats)(nil)
	}
	r := new(QueryRangeResponse_Stats)
	r.Stats = m.Stats.CloneVT()
	return r
}
