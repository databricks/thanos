...
type StoreInfo struct {
	...
	// Replica topology hints for the QUORUM partial response strategy.
	...
	// If empty, the store is treated as a singleton store.
	...
	// If 0 or not set, the store is treated as a singleton store.
