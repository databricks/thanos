...
proto: check-git $(GOIMPORTS) $(PROTOC) $(PROTOC_GEN_GOGOFAST) $(PROTOC_GEN_GO) $(PROTOC_GEN_GO_GRPC) $(PROTOC_GEN_GO_VTPROTO) $(PROTOC_GEN_GOTAG)
	@GOIMPORTS_BIN="$(GOIMPORTS)" PROTOC_BIN="$(PROTOC)" \
	  PROTOC_GEN_GOGOFAST_BIN="$(PROTOC_GEN_GOGOFAST)" \
	  PROTOC_GEN_GO_BIN="$(PROTOC_GEN_GO)" \
	  PROTOC_GEN_GO_GRPC_BIN="$(PROTOC_GEN_GO_GRPC)" \
	  PROTOC_GEN_GO_VTPROTO_BIN="$(PROTOC_GEN_GO_VTPROTO)" \
	  PROTOC_GEN_GOTAG_BIN="$(PROTOC_GEN_GOTAG)" \
	  PROTOC_VERSION="$(PROTOC_VERSION)" scripts/genproto.sh
