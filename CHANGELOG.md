...
- [#206](https://github.com/databricks/thanos/pull/206) Thanos Query: add `--block-query-metrics-without-filter` flag to block high-cardinality metric queries without sufficient label filters
